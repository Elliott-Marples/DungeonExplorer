...
namespace DungeonExplorer
{
    ...
    {
        public static AttackItem    sabre  = new AttackItem("Sabre", "A sword that makes you feel prepared for battle.", "The Sabre makes you prepared for battle (+15 attack).", 15);
